#!/usr/bin/env python3
"""Run ONE problem of tau2 through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/tau2_airline"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one tau2 problem via TrustedRouter")
